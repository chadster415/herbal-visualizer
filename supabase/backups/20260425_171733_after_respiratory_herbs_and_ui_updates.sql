...
\restrict 5oFTZSdijXduhvKS0HJJuuzYgiraJNPssDA75ZY17A3zS46IxOxdPcjo1GJadlp
...
SELECT pg_catalog.setval('herbal.body_systems_id_seq', 19, true);
...
SELECT pg_catalog.setval('herbal.disorder_action_herbs_id_seq', 298, true);
...
SELECT pg_catalog.setval('herbal.disorder_actions_indicated_id_seq', 197, true);
...
SELECT pg_catalog.setval('herbal.disorder_notes_id_seq', 164, true);
...
SELECT pg_catalog.setval('herbal.disorder_prescriptions_id_seq', 57, true);
...
SELECT pg_catalog.setval('herbal.disorder_specific_remedies_id_seq', 236, true);
...
SELECT pg_catalog.setval('herbal.disorders_id_seq', 68, true);
...
SELECT pg_catalog.setval('herbal.herb_primary_actions_id_seq', 1198, true);
...
SELECT pg_catalog.setval('herbal.herbs_id_seq', 593, true);
...
SELECT pg_catalog.setval('herbal.prescription_herbs_id_seq', 230, true);
...
SELECT pg_catalog.setval('herbal.primary_actions_id_seq', 232, true);
...
\unrestrict 5oFTZSdijXduhvKS0HJJuuzYgiraJNPssDA75ZY17A3zS46IxOxdPcjo1GJadlp
